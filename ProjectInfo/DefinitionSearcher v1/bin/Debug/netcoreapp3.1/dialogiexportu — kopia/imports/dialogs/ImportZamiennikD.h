...
class CCommonZamiennikImport;

class CImportZamiennikiD : public CMyDialog, public CCommonWTIDlgTPL<CCommonZamiennikImport>
{
    DECLARE_DYNAMIC(CImportZamiennikiD)

public:
    CImportZamiennikiD();   // standard constructor
    virtual ~CImportZamiennikiD();

    // Dialog Data
    enum { IDD = IDD_ZAMIENNIKI_IMPORT };
    ...
    void executeItFromThreadTPL(CCommonStatusRet* sr, CCommonWTIParamTPL<CCommonZamiennikImport>& prm);

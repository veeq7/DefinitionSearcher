...
class CCommonCzZamiennaImport;

class CImportCzZamiennychD : public CMyDialog, public CCommonWTIDlgTPL<CCommonCzZamiennaImport>
{
    DECLARE_DYNAMIC(CImportCzZamiennychD)

public:
    CImportCzZamiennychD();   // standard constructor
    virtual ~CImportCzZamiennychD();

    // Dialog Data
    enum { IDD = IDD_CZZAMIENNE_IMPORT };
    ...
    void executeItFromThreadTPL(CCommonStatusRet* sr, CCommonWTIParamTPL<CCommonCzZamiennaImport>& prm);
